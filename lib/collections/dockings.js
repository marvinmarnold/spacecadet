...
if (Meteor.isClient) {
  Template.registerHelper("prettyDockingSubtotal", function (dailyPrice) {
    return accounting.formatMoney(dockingSubtotal(dailyPrice, dockingDurationDays()));
  });

  Template.registerHelper("prettyDockingSpaceCadetServiceFee", function (dailyPrice) {
    return accounting.formatMoney(dockingSpaceCadetServiceFee(dailyPrice, dockingDurationDays()));
  });

  Template.registerHelper("prettyDockingCheckoutTotal", function (dailyPrice) {
    return accounting.formatMoney(dockingCheckoutTotal(dailyPrice, dockingDurationDays()));
  });

  Template.registerHelper("dockingDurationDays", function () {
    return dockingDurationDays() + " days";
  });
...
////////////////////////////////////////////////////////////////////////////////
if (Meteor.isClient) {
  var getStartDockingOn = function() {
    return Session.get('startDockingOn');
  }

  var getEndDockingOn = function() {
    return Session.get('startEndOn');
  }

  var dockingDurationDays = function() {
    return dockingDurationDays(getStartDockingOn(), getEndDockingOn());
  }
}

var dockingDurationDays = function(startDockingOn, endDockingOn) {
